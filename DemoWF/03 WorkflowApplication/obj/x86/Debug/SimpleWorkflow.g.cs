...
namespace _03_WorkflowApplication {
    ...
    public partial class SimpleWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SimpleWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SimpleWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(SimpleWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SimpleWorkflow.g.xaml") || resource.Equals("SimpleWorkflow.g.xaml"))) {
                    return resource;
                }
            }
